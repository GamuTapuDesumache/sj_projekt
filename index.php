...
<body>
    ...
    <div id="templatemo_main">
    	...
    	<div class="col_w960">
        	...
        	<h2>Tie najlepšie CSS dizajny</h2>
            <p>Naša stránka je najlepšie miesto pre hľadanie CSS frameworkov pre vašu stránku. Máme pre vás formáty, ktoré si zamilujete. Všetky naše služby sú úplne zdarma a
                nemusíte sa báť, že vám stránka nebude fungovať. Všetky naše výtvory nájdete v <a href="gallery.php"> našej galérii</a>
            </p>
